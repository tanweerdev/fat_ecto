defmodule Query.IncludeTest do
  ...
  #   query = from(h in FatEcto.FatHospital , where: h.id == ^10, order_by: [asc: h.id], limit: ^10, offset: ^0)
  ...
  #   opts = %{
  #     "$include" => %{
  #       "hospitals" => %{"$join" => "$left", "$order" => %{"id" => "$asc"}, "$where" => %{"id" => 10}}
  #     }
  #   }
  ...
  #   opts = %{
  #     "$include" => %{
  #       "hospitals" => %{"$join" => "$right", "$order" => %{"id" => "$desc"}, "$where" => %{"name" => "Saint"}}
  #     },
  #     "$where" => %{"name" => "John"}
  #   }

  #   query = from(h in FatEcto.FatHospital , where: h.name == ^"Saint", order_by: [desc: h.id], limit: ^10, offset: ^0)
  ...
  test "returns the query with include associated model and inner join" do
    opts = %{
      "$include" => %{
        "hospitals" => %{"$join" => "$inner", "$order" => %{"id" => "$desc"}, "$where" => %{"name" => "Saint"}}
      },
      "$where" => %{"name" => "John"},
      "$order" => %{"id" => "$asc"}
    }
  ...
  #   opts = %{
  #     "$include" => %{
  #       "hospitals" => %{"$join" => "$full", "$order" => %{"id" => "$desc"}, "$where" => %{"name" => "Saint"}}
  #     },
  #     "$where" => %{"name" => "John"}
  #   }
  ...
  #   query = from(h in FatEcto.FatHospital , left_join: r in assoc(h, :rooms), limit: ^10, offset: ^0, preload: [:rooms])
  ...
  #   opts = %{
  #     "$include" => %{"hospitals" => %{"$include" => ["rooms", "patients"], "$order" => %{"id" => "$asc"}}}
  #   }
